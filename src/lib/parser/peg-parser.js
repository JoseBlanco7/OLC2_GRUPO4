...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(head, expr) {
    return { nombre: head, expresion: expr };
  };
  var peg$f2 = function(grp) { return { tipo: "repeticion", modo: "cero_o_mas", valor: grp }; };
  var peg$f3 = function(grp) { return { tipo: "repeticion", modo: "una_o_mas", valor: grp }; };
  var peg$f4 = function(grp) { return { tipo: "repeticion", modo: "opcional", valor: grp }; };
  var peg$f5 = function(alt) { return { tipo: "grupo", valor: alt }; };
  var peg$f6 = function(chars) { return { tipo: "literal", valor: chars.join("") }; };
  var peg$f7 = function(chars) { return { tipo: "literal", valor: chars.join("") }; };
